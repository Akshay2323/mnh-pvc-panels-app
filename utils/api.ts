...
import {
  ...
  ProductDetailResp,
  ProductGalleryData,
  ProductGalleryDetailsData,
  ProductGalleryDetailsResp,
  ProductGalleryResp,
  ProductResp,
...
export const getHomeDetails = async (): Promise<HomeScreenContentResp> => {
  try {
    const response = await api.get<HomeScreenContentResp>(
      "/webSettings/homeScreenContent"
    );
...
export const getAboutUsDetails = async (): Promise<AboutUsContentResp> => {
  try {
    const response = await api.get<AboutUsContentResp>(
      "/webSettings/aboutUsContent"
    );
    return response.data;
  } catch (error: any) {
    return {
...
export const getManufacturerDetails =
  async (): Promise<ManufacturerContentResp> => {
    try {
      const response = await api.get<ManufacturerContentResp>(
        "/webSettings/manufacturerContent"
      );
      return response.data;
    } catch (error: any) {
      return {
...
export const getPvcWallDetails = async (): Promise<PvcWallContentResp> => {
  try {
    const response = await api.get<PvcWallContentResp>(
      "/webSettings/pvcWallContent"
    );
    return response.data;
  } catch (error: any) {
    return {
...
export const getContactDetails = async (): Promise<ContactContentResp> => {
  try {
    const response = await api.get<ContactContentResp>(
      "/webSettings/contactContent"
    );
    return response.data;
  } catch (error: any) {
    return {
...
export const sendBecomeDealer = async (
  param: BecomeDealerParam
): Promise<UserContactResp> => {
  try {
...
export const sendQuote = async (
  param: UserQuoteParam
): Promise<UserQuoteResp> => {
  try {
...
export const getCategoryWithSubCategory = async (): Promise<CategoryResp> => {
  try {
    const response = await api.get<CategoryResp>(
      "/productCategory/categoryWithSubCategory"
    );
    return response.data;
  } catch (error: any) {
    return {
...
export const productSubCategory = async (): Promise<SubCategoryResp> => {
  try {
    const response = await api.get<SubCategoryResp>(
      "/productSubCategory/active"
    );
    return response.data;
  } catch (error: any) {
    return {
...
export const getProductsByCategory = async (
  ...
  try {
    const response = await api.get<ProductResp>(
...
export const getProductGallery = async (
  ...
  search?: string,
  category?: string
): Promise<ProductGalleryResp> => {
  try {
    const response = await api.get<ProductGalleryResp>(
      "/productGallery/activeGalleryProducts",
      {
        params: {
          page,
          limit,
...
export const getProductCatalog = async (): Promise<ProductCatalogResp> => {
  try {
    const response = await api.get<ProductCatalogResp>(
      "/productCatalog/activeProductCatalogs"
    );
...
export const getProductSubCatagoryByCategory = async (
  categoryId: string
): Promise<ProductSubCatagoryResp> => {
  try {
    const response = await api.get<ProductSubCatagoryResp>(
      "/productSubCategory/getSubCategoryByCategory/" + categoryId
    );
    return response.data;
  } catch (error: any) {
    return {
...
export const getProductGalleryById = async (
  eventId: string
): Promise<ProductGalleryDetailsResp> => {
  try {
    const response = await api.get<ProductGalleryDetailsResp>(
      "/productGallery/" + eventId
    );
    return response.data;
  } catch (error: any) {
    return {
      status: false,
      message: error?.message || "Failed to fetch product gallery content",
      data: new ProductGalleryDetailsData(),
    };
  }
};
