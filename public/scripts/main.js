...
function initAnima(obj) {
    (function ($) {
        var animaTimeout = $.fn.getGlobalVar("animaTimeout"); var animaTimeout_2 = $.fn.getGlobalVar("animaTimeout_2"); var da = $(obj).attr("data-anima"); var an = $(obj).find(".anima,[data-anima]"); var t = $(obj).attr("data-time"); var ta = $(obj).attr("data-target"); var tm = $(obj).attr("data-timeline"); var tmt = $(obj).attr("data-timeline-time"); var tr = $(obj).attr("data-trigger"); var len = $(an).length; var default_anima = $.fn.getGlobalVar("default_anima"); if (da == "default" && !isEmpty(default_anima)) da = default_anima; if (isEmpty(tmt)) tmt = 500; if (isEmpty(an)) an = obj; $(an).each(function (i) { if (!isEmpty($(this).attr("data-anima")) && i === 0) { an = obj; return false; } }); if (!isEmpty(ta)) an = $(ta); if (isEmpty(t)) t = 500; var time = 0, p = 1; if (!isEmpty(tm) && tm === "desc") { time = (len - 1) * tmt; p = -1 }; var cont = null; $(an).each(function (index) {
            var time_now = time; if (index === len - 1 && tm === "desc") time_now = 0; if (!$(this).hasClass("anima") && an != obj && isEmpty(ta)) { cont = this; } else {
                if (cont != null && !$.contains(cont, this) || cont === null) {
                    var tobj = this; var pos = $(this).css("position"); if (pos != 'absolute' && pos != 'fixed') $(this).css("position", "relative"); var aid = Math.random(5) + ""; $(tobj).attr("aid", aid); if (animaTimeout.length > 30) { animaTimeout.shift(); animaTimeout_2.shift(); }
                    animaTimeout.push([aid, setTimeout(function () {
                        $(tobj).css(cssInit(0, 0)); var da_ = da; if (!isEmpty($(tobj).attr('class')) && $(tobj).attr('class').indexOf("anima-") != -1) { var arr_a = $(tobj).attr('class').split(" "); for (var i = 0; i < arr_a.length; i++) { if (arr_a[i].indexOf("anima-") != -1) da_ = arr_a[i].replace("anima-", ""); } }
                        if ($(window).width() < 768 && (isEmpty(tr) || tr === "scroll" || tr === "load")) da_ = "fade-in"; animaTimeout_2.push([aid, setTimeout(function () { $(tobj).css(cssInit(0, t)).addClass(da_); $(tobj).css('opacity', '') }, 100)]);
                    }, time_now)]); if (!isEmpty(tm)) time += tmt * p;
                }
            }
        }); $.fn.setGlobalVar(animaTimeout, "animaTimeout"); $.fn.setGlobalVar(animaTimeout_2, "animaTimeout_2");
    }(jQuery));
}
function outAnima(obj) {
    (function ($) {
        var animaTimeout = $.fn.getGlobalVar("animaTimeout"); var animaTimeout_2 = $.fn.getGlobalVar("animaTimeout_2"); var da = $(obj).attr("data-anima"); var an = $(obj).find(".anima,[data-anima]"); var t = $(obj).attr("data-time"); var hidden = $(obj).attr("data-hidden"); var ta = $(obj).attr("data-target"); var default_anima = $.fn.getGlobalVar("default_anima"); if (da == "default" && !isEmpty(default_anima)) da = default_anima; if (isEmpty(an)) an = obj; if (!isEmpty(ta)) an = $(ta); if (isEmpty(t)) t = 500; var cont = null; $(an).each(function () {
            var aid = $(this).attr("aid"); if (!isEmpty(aid)) {
                for (var i = 0; i < animaTimeout.length; i++) { if (animaTimeout[i][0] == aid) { clearTimeout(animaTimeout[i][1]); } }
                for (var i = 0; i < animaTimeout_2.length; i++) { if (animaTimeout_2[i][0] == aid) { clearTimeout(animaTimeout_2[i][1]); } }
            }
            if (!$(this).hasClass("anima") && an != obj) { cont = this; } else {
                if (cont != null && !$.contains(cont, this) || cont == null) {
                    var pos = $(this).css("position"); if (pos != 'absolute' && pos != 'fixed') $(this).css("position", "relative"); var da_ = da; try { if ($(this).attr('class').indexOf("anima-") != -1) { var arr_a = $(this).attr('class').split(" "); for (var i = 0; i < arr_a.length; i++) { if (arr_a[i].indexOf("anima-") != -1) da_ = arr_a[i].replace("anima-", ""); } } } catch (e) { }
                    $(this).css(cssInit(0, t)).removeClass(da_); var op = parseFloat($(this).css("opacity")); if (op > 0 && op < 1) $(this).css("opacity", 1);
                }
            }
        }); if (hidden) { $(an).css(cssInit(0, t)).css("opacity", 0); setTimeout(function () { $(an).css("opacity", 0); }, 400); }
        $.fn.setGlobalVar(animaTimeout, "animaTimeout"); $.fn.setGlobalVar(animaTimeout_2, "animaTimeout_2");
    }(jQuery));
}
...
(function ($) {
    var arrFA = []; var firstLoad = true; var animaTimeout = []; var animaTimeout_2 = []; var default_anima; var window_width = $(window).width(); var window_height = $(window).height(); var body; var nav; var front_composer; var header; var parallax_items; var parallax_title_video = false; var footer_parallax; var sections_slider_parallax; $(document).ready(function () {
        body = $("body"); nav = $("body > nav"); header = $(body).find(" > header"); parallax_items = $(body).find("[data-parallax]"); footer_parallax = $(body).find(" > footer.footer-parallax"); sections_slider_parallax = $(body).find(" > main > .section-slider[data-slider-parallax]"); if (!isEmpty(getURLParameter("hc"))) front_composer = true; $(body).on("click", "[data-social]", function () {
            var a = $(this).attr("data-social"); var link = $(this).attr("data-social-url"); var purl = link; if (isEmpty(link)) purl = window.location.href; var url = 'https://www.facebook.com/sharer/sharer.php?u=' + purl; if (a == 'share-twitter') { url = 'https://twitter.com/intent/tweet?text=' + $('meta[name=description]').attr("content"); if (!isEmpty(link)) url = 'https://twitter.com/intent/tweet?url=' + link; }
            if (a == 'share-google') url = 'https://plus.google.com/share?url=' + purl; if (a == 'share-linkedin') url = 'https://www.linkedin.com/shareArticle?url=' + purl; openWindow(url);
        }); $(body).find("[data-anima]").each(function () {
            var tr = $(this).attr("data-trigger"); if (isEmpty(tr) || tr == "scroll" || tr == "load") { var an = $(this).find(".anima,*[data-anima]"); if (isEmpty(an)) an = this; var cont = null; var x = 0; $(an).each(function () { if (!$(this).hasClass("anima") && an != this) { cont = this; } else { if (cont != null && !$.contains(cont, this) || cont == null) { $(this).css("opacity", 0); x++; } } }); if (x == 0) $(this).css("opacity", 0); }
            if (!isEmpty(tr) && tr == "load") initAnima(this);
        }); $(body).on("click", "[data-anima][data-trigger=click]", function () { outAnima(this); initAnima(this); }); $(body).on("mouseenter", "[data-anima][data-trigger=hover]", function () { initAnima(this); }); $(body).on("mouseleave", "[data-anima][data-trigger=hover]", function () { $(this).stop(true, false); outAnima(this); }); if (window_width > 992) {
            $(nav).on("click", ".search-box-menu > i", function () { $(this).parent().toggleClass("active"); }); $(body).on("mouseenter", "nav[data-menu-anima] .menu-cnt > ul > li > a,nav[data-menu-anima] .lan-menu > li > a", function () { $(this).parent().find(" > ul, > .mega-menu").css("opacity", 0).css("transition-duration", "0ms").showAnima($("nav").data("menu-anima")); }); $(body).on("mouseenter", ".menu-subline .menu-cnt > ul li", function () { $(nav).find(".subline-bar ul").removeClass("active").eq($(this).index()).addClass("active"); }); $(nav).on("mouseleave", ".subline-bar", function () { $(this).find("ul").removeClass("active"); }); if ($(nav).hasClass("menu-side-collapse")) { $(nav).on("click", ".menu-cnt > ul > li > a", function () { var item = $(this).parent(); var active = $(item).hasClass("active"); $(nav).find(".menu-cnt > ul > li").removeClass("active"); if (!active) { var sub_menu = $(item).find(" > ul,.mega-menu"); $(item).addClass("active"); if (sub_menu.length) { var item_height = $(sub_menu).height() + 15; $(sub_menu).css("height", "0"); $(sub_menu).animate({ height: item_height }, 500, function () { $(sub_menu).css("height", "") }); } } }); }
        ...
        $(nav).on("click", ".menu-btn", function () {
            ...
            if (!active) $(nav).addClass("active"); $(menu_cnt).animate({ height: h }, 300, function () { setTimeout(function () { if (active) { $(nav).removeClass("active"); $(menu_cnt).css("height", "0"); } else { $(menu_cnt).css("height", "auto"); } }, 300); });
        }); $(body).on("click", ".menu-inner-vertical .dropdown", function () { var active = $(this).hasClass("active"); $(this).closest(".menu-inner").find(".dropdown").removeClass("active"); if (!active) $(this).addClass("active"); }); $(body).on("click", ".menu-inner:not(.menu-inner-vertical) > div", function () { $(this).parent().toggleClass("active"); }); onePageScroll($(".menu-inner,.menu-one-page")); if (navigator.userAgent.indexOf('MSIE') !== -1 || navigator.appVersion.indexOf('Trident/') > 0) { $(body).addClass("iex"); }
        $(body).on("click", 'a[href="#"]', function (e) { e.preventDefault(); }); $(body).find("[data-href].lightbox").each(function () { $(this).attr("href", $(this).attr("data-href")); $(this).initMagnificPopup(); }); $(body).on("click", "[data-href]", function (e) {
        ...
        }); $(body).on("click", ".album-title > a", function () { var album = $(this).closest(".album"); $(album).removeClass("active"); $(album).find(".album-list").css("opacity", 0).showAnima("fade-in") }); if ($(header).hasClass("header-video")) { $(header).find(" > video").set_video_size($(header).width(), $(header).height()); if ($(header).hasClass("video-parallax")) parallax_title_video = true; }
        ...
        setTimeout(function () { $(window).scroll(); }, 50); $(body).on("click", ".scroll-top", function () { $("html, body").stop().animate({ scrollTop: 0 }, '500', 'swing'); }); $(body).on("click", ".scroll-to", function (e) {
            var t = $(this).attr("data-scroll-to"); if (isEmpty(t)) t = $(this).attr("href"); if (isEmpty(t)) t = $(this).attr("data-href"); try { $(t).scrollTo(); } catch (e) { }
            if (t.indexOf("#") == 0 && ($(this).hasClass("btn") || $(this).hasClass("btn-text"))) e.preventDefault();
        }); $(body).addClass("no-transactions"); $(body).find(' > #preloader').fadeOut(300); setTimeout(function () { $(body).removeClass("no-transactions"); }, 400); var header_cnt = $(header).find(".container"); var data_anima = $("[data-anima]"); var scroll_1 = $(".scroll-hide"); var scroll_2 = $(".scroll-change"); var scroll_3 = $(".scroll-show"); var scroll_4 = $(".scroll-top-btn"); var scroll_5 = $(".scroll-show-mobile"); var scroll_6 = $("nav.scroll-change .navbar-brand"); var scroll_len = $(".fp-enabled").length; var old_scroll = 0; var scroll_detect = $("[data-scroll-detect] li"); var scroll_detect_items = []; if (scroll_detect.length) { $(scroll_detect).each(function () { var target = $(this).find("a").attr("href"); if (target.length > 1) { scroll_detect_items.push($(body).find($(this).find("a").attr("href"))); } }); }
        $(window).scroll(function () {
            var scroll = $(window).scrollTop(); if (old_scroll != scroll || old_scroll == 0) {
                var po = window.pageYOffset; var go = true; var dh = $(document).height(); old_scroll = scroll; if (scroll < 2200) { $(header_cnt).css("margin-top", po).css("opacity", (100 / po < 1) ? (100 / po) : 1); if (parallax_title_video) { $(header).find(" > video").css("margin-top", po); } }
    ...
    $.fn.set_video_size = function (w, h) {
        var video_height = $(this).height(); var video_width = $(this).width(); var new_width; var new_height; if (video_height < h || video_width < w) { var proportion = h / video_height; new_width = w * proportion; $(this).css("width", new_width + "px"); }
    ...
    $.fn.initYoutubeVideo = function () {
        var id = $(this).attr("data-video-youtube"); if (!isEmpty(id)) {
            if (id.indexOf("http:") != -1 || id.indexOf("www.you") != -1 || id.indexOf("youtu.be") != -1) { if (id.indexOf("?v=") != -1) id = id.substring(id.indexOf("v=") + 2); if (id.indexOf("youtu.be") != -1) id = id.substring(id.lastIndexOf("/") + 1); }
    ...
    $.fn.renderLoadedImgs = function () {
        if ($.isFunction($.fn.imagesLoaded)) {
            var isIsotope = false; var $isotope; var imgLoad = imagesLoaded($(this)); if ($(this).hasClass("maso-box")) { isIsotope = true; $isotope = this; }
            imgLoad.on('progress', function (instance, image) {
                if (!$(image.img).parent().hasClass("hc-image")) {
                    var result = image.isLoaded ? 'loaded' : 'broken'; var target = "a"
                    ...
                    if (result == "loaded") {
                        if (isIsotope) { $isotope.isotope('layout'); var mi = $(image.img).closest('.maso-item'); $(mi).css("visibility", "visible"); $(mi).find("> *").animate({ "opacity": 1 }, 300); }
    ...
    $.fn.initPagination = function () {
        ...
        t.isotope('layout'); if (type == 'pagination') {
            var optionsArr; var options = {
                totalPages: Math.ceil(n / p), visiblePages: 7, first: "First", last: "Last", next: "Next", prev: "Previous", onPageClick: function (event, page) {
                    t.isotope('remove', t.isotope('getItemElements')); for (var i = (p * (page - 1)); i < (p * (page)); i++) { t.isotope('insert', items[i]); }
        ...
        function loadMoreMaso(obj) {
            var page = $(obj).attr("data-current-page"); if (isEmpty(page)) page = 1; page++; $(obj).attr("data-current-page", page); var s = p * (page - 1); var e = p * (page); for (var i = s; i < (p * (page)); i++) { t.isotope('insert', items[i]); }
    ...
    $.fn.initIsotope = function () {
        if ($.isFunction($.fn.isotope)) {
            var m = $(this).find('.maso-box'); var menu = $(this).find(".menu-inner"); var optionsString = $(this).attr("data-options"); var optionsArr; var options = { itemSelector: '.maso-item', percentPosition: true, masonry: { columnWidth: '.maso-item', horizontalOrder: true }, getSortData: { number: function (e) { return parseInt(jQuery(e).attr('data-sort'), 10); } }, sortBy: 'number' }
    ...
    $.fn.initMagnificPopup = function () {
        var obj = this; var optionsString = $(obj).attr("data-options"); var trigger = $(obj).attr("data-trigger"); if (isEmpty(trigger)) trigger = ""; var a = $(obj).attr("data-lightbox-anima"); var href = $(obj).attr("href"); if (isEmpty(href)) href = ""; if (isEmpty(a)) a = $(obj).parent().attr("data-lightbox-anima"); var optionsArr; var options = { type: 'iframe' }
        if (!isEmpty(optionsString)) { optionsArr = optionsString.split(","); options = getOptionsString(optionsString, options); }
        if (isEmpty(options['mainClass'])) options['mainClass'] = ""; if (trigger == "load" || trigger == "scroll") {
            var l = $(obj).attr("data-link"); var c = $(obj).attr("data-click"); if (isEmpty(l)) { href = "#" + $(this).attr("id"); options['mainClass'] += ' custom-lightbox'; }
        ...
        options["callbacks"] = {
            open: function () {
                var mfp_cnt = $('.mfp-content'); if (!isEmpty(a)) { $(mfp_cnt).showAnima(a); $(mfp_cnt).css("opacity", 0); } else { if ((!isEmpty(optionsString)) && optionsString.indexOf("anima:") != -1) { $(mfp_cnt).showAnima(options['anima']); $(mfp_cnt).css("opacity", 0); } }
                if (href.indexOf("#") == 0) { $(href).css("display", "block"); }
                var gm = $(mfp_cnt).find(".google-map"); if ($.isFunction($.fn.googleMap) && $(gm).length) $(gm).googleMap();
            }, change: function (item) { var h = this.content; $('.mfp-container').removeClass("active"); setTimeout(function () { $('.mfp-container').addClass("active"); }, 500); var gm = $(h).find(".google-map"); if ($.isFunction($.fn.googleMap) && $(gm).length) $(gm).googleMap(); }, close: function () { if ($.isFunction($.fn.fullpage) && $.isFunction($.fn.fullpage.setMouseWheelScrolling)) $.fn.fullpage.setMouseWheelScrolling(true); }
        ...
        var parent = $(this).parent(); if ($(parent).hasClass("slimScrollDiv")) { $(this).removeData('slimScroll'); $(parent).find(".slimScrollBar").remove(); $(parent).find(".slimScrollRail").remove(); $(parent).replaceWith(this); }
        $(this).initSlimScroll();
    }
    $.fn.initSlimScroll = function () {
        ...
        let disable_md = $(this).hasClass("disable-md"); let disable_sm = $(this).hasClass("disable-sm"); if ((disable_md && window_width > 992) || (disable_sm && window_width > 768) || (!disable_md && !disable_sm) || window_width > 992) {
            var vh = $(this).attr("data-height"); var lh = $(this).attr("data-offset"); var railColor = $(this).attr("data-rail-color"); var barColor = $(this).attr("data-bar-color"); var optionsString = $(this).attr("data-options"); var optionsArr; var options = { height: 0, size: '4px', railVisible: true, alwaysVisible: true, color: (isEmpty(barColor) ? '#888888' : barColor), railColor: (isEmpty(railColor) ? '#e6e6e6' : railColor), railOpacity: 1 }
            if (!isEmpty(optionsString)) { optionsArr = optionsString.split(","); options = getOptionsString(optionsString, options); }
            ...
            options['height'] = vh + "px"; $(this).slimScroll(options); var gm = $(this).find(".google-map"); if ($.isFunction($.fn.googleMap) && $(gm).length) $(gm).googleMap(); if (!options['alwaysVisible']) $(".slimScrollBar").hide(); if (window_width < 993) $(this).find(".slimScrollBar").css("height", "50px"); $(this).on("mousewheel DOMMouseScroll", function (n) { n.preventDefault() }); $(this).slimScroll().bind('slimscroll', function (e, pos) {
                if (pos != "scrolling") { $(this).removeClass("scroll-pos-top").removeClass("scroll-pos-bottom"); }
