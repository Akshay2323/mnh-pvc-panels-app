...
export default function BlogPage({ initialData }: BlogPageProps) {
  ...
  return (
    <React.Fragment>
      <SEO
        title={initialData?.keywords.title || 'Blog'}
                      ...
                      <div className='grid-box'>
                        {blogs.map((blog) => (
                          <div key={blog.id} className='grid-item'>
                            <div
                              className='cnt-box cnt-box-blog-side boxed'
                              data-href={`/blog/${blog.id}`}
                            >
                              <Link
                                href={`/blog/${blog.id}`}
                                className='img-box'
                              >
                                {blog.type == BLOG_MEDIA_TYPE.VIDEO ? (
                                  <YouTube
                                    ref={(ref) => {
                                      if (ref) {
                                  ...
                                  <CustomImage
                                    src={blog.media || '/assets/logo.jpeg'}
                                    alt=''
                                    layout='fill'
                                    objectFit='contain'
                                  />
                              ...
                              <div className='caption'>
                                ...
                                <ul className='icon-list icon-list-horizontal'>
                                  ...
                                  <li>
                                    ...
                                    <a href='#'>{blog.productCategory?.name}</a>
                                  </li>
                                </ul>
                                <p>{blog.sortDescription}</p>
                              </div>
                            </div>
                          </div>
                        ))}
